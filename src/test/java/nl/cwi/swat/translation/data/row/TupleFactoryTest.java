...
class TupleFactoryTest {
  ...
  @Property
  public void tuplesWithArityUpToFiveAreOfSpecialisedType(
    ...
    switch (arity) {
      case 0:
        ...
        break;
      case 1:
        assertTrue(tuple instanceof UnaryTuple);
        break;
      case 2:
        assertTrue(tuple instanceof BinaryTuple);
        break;
      case 3:
        assertTrue(tuple instanceof TernaryTuple);
        break;
      case 4:
        assertTrue(tuple instanceof FourAttributesTuple);
        break;
      case 5:
        assertTrue(tuple instanceof FiveAttributesTuple);
        break;
      default:
  ...
  @Property
  public void arityIsEqualToNumberOfAttributesInTuple(
          @ForAll @IntRange(max = 50) int arity) {
    assertEquals(arity, buildTuple(atts(arity)).arity());
  }

  @Property
  public void buildingAPartialTupleWhenFilteringEverythingLeavesTheEmptyTuple(
          @ForAll @IntRange(max = 50) int arity) {
...
//  @Property
//  public void buildingAPartialTupleWithIndicesOutsideBoundsThrowsException(
//          @ForAll @IntRange(max = 50) int arity, Set<@ForAll @IntRange(max = 70) Integer> indices) {
